        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
          ...
          <div class="items-center md:flex">
            <div class="flex flex-col mt-2 md:flex-row md:mt-0 md:mx-1">
              ...
              <Link to="/home" class="my-1 text-sm leading-5 text-gray-700 transition-colors duration-200 transform dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 hover:underline md:mx-4 md:my-0">
                Dashboard
              </Link>
              <Link
                to="/jobs"
